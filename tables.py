...
class Product(db.Model):
    ...
    @staticmethod
    def delete(p_id):
        Product.query.filter_by(id=p_id).delete()
        db.session.commit()
...
class VendingMCProduct(db.Model):
    ...
    @staticmethod
    def get_all_relation_by_mc(mc_id):
        return VendingMCProduct.query.filter_by(vendingMC_id=mc_id).all()

    @staticmethod
    def get_all_relation_by_prod(p_id):
        return VendingMCProduct.query.filter_by(product_id=p_id).all()
